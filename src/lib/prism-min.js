!function a(b, c, d) {
    ...
    2: [function (a, b, c) {
        var d = a("./player/player"), e = a("./player/flashplayer"), f = a("./lib/dom"), g = a("./lib/ua"), h = a("./lib/object"), i = a("./config"), j = function (a) {
            var b, c = a.id;
            if ("string" == typeof c) {
            ...
            if (g.IS_H5 && a.isLive && (i.skinLayout = [{
                    name: "bigPlayButton",
                    align: "blabs",
                    x: 30,
                    y: 80
                    ...
                    x: 0,
                    y: 0,
                    children: [{name: "liveDisplay", align: "tlabs", x: 15, y: 25}, {
                        name: "fullScreenButton",
                        align: "tr",
                        x: 20,
                        y: 25
                    }, {name: "volume", align: "tr", x: 20, y: 25}]
                }]), g.IS_IOS)for (var k = 0; k < i.skinLayout.length; k++)if ("controlBar" == i.skinLayout[k].name)for (var l = i.skinLayout[k], m = 0; m < l.children.length; m++)if ("volume" == l.children[m].name) {
                l.children.splice(m, 1);
                break
            }
            if (i.width && (b.style.width = i.width), i.height) {
                b.style.height = i.height
            }
            return b.player || (g.IS_H5 ? new d(b, i) : new e(b, i))
    ...
    4: [function (a, b, c) {
        ...
        b.exports.cache = {}, b.exports.guid = function (a, b) {
            ...
            if (b = b || d.length, a)for (c = 0; c < a; c++)e[c] = d[0 | Math.random() * b]; else {
                var f;
    ...
    6: [function (a, b, c) {
        ...
        b.exports.on = function (a, c, g) {
            ...
            if (c = b.exports.fixEvent(c), d.dispatcher && d.dispatcher.call(a, c), e && !c.isPropagationStopped() && c.bubbles !== !1)b.exports.trigger(e, c); else if (!e && !c.defaultPrevented) {
    ...
    8: [function (a, b, c) {
        ...
        b.exports.get = function (a, b, c, e) {
            ...
            var d = "jsonp_callback_" + Math.round(1e5 * Math.random()), e = document.createElement("script");
            e.src = a + (a.indexOf("?") >= 0 ? "&" : "?") + "callback=" + d, e.onerror = function () {
    ...
    9: [function (a, b, c) {
        ...
        b.exports.render = function (a, b) {
            var c = b.align ? b.align : "tl", e = b.x ? b.x : 0, f = b.y ? b.y : 0;
            "tl" === c ? d.css(a, {
                float: "left",
                "margin-left": e + "px",
                "margin-top": f + "px"
    ...
    10: [function (a, b, c) {
        ...
        b.exports.create = Object.create || function (a) {
            ...
            if (b.exports.isArray(a))for (var f = 0, g = a.length; f < g && c.call(e || this, a[f], f) !== !1; ++f); else for (var h in a)if (d.call(a, h) && c.call(e || this, h, a[h]) === !1)break;
            return a
    ...
    13: [function (a, b, c) {
        ...
        b.exports.getAbsoluteURL = function (a) {
            ...
            var b, c, e, f, g;
            f = ["protocol", "hostname", "port", "pathname", "search", "hash", "host"], c = d.createEl("a", {href: a}), e = "" === c.host && "file:" !== c.protocol, e && (b = d.createEl("div"), b.innerHTML = '<a href="' + a + '"></a>', c = b.firstChild, b.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(b)), g = {};
    ...
    15: [function (a, b, c) {
        var d, e = a("../lib/oo"), f = a("../lib/object"), g = a("../lib/cookie"), h = a("../lib/data"), i = a("../lib/io"), j = a("../lib/ua"), k = a("../config"), l = {
            INIT: 1001,
            CLOSE: 1002,
            PLAY: 2001,
            STOP: 2002,
            ...
            init: function (a, b) {
                this.player = a;
                var c = this.player.getOptions(), d = "1", e = b.from ? b.from : "prism_aliyun", f = c.isLive ? "prism_live" : "prism_vod", g = "pc";
                j.IS_IPAD ? g = "pad" : j.IS_IPHONE ? g = "iphone" : j.IS_ANDROID && (g = "andorid");
                var h = j.IS_PC ? "pc_h5" : "h5", i = k.h5Version, l = this._getUuid(), m = c.source ? encodeURIComponent(c.source) : b.video_id, n = "0", o = this.sessionId, p = "0", q = "0", r = "custom", s = "0.0.0.0", t = (new Date).getTime();
                this.opt = {
                    APIVersion: "0.6.0",
                    lv: d,
                    b: e,
                ...
                var b = this.player.getOptions(), c = "1", d = a.from ? a.from : "prism_aliyun", e = b.isLive ? "prism_live" : "prism_vod", f = "pc";
                j.IS_IPAD ? f = "pad" : j.IS_IPHONE ? f = "iphone" : j.IS_ANDROID && (f = "andorid");
                var g = j.IS_PC ? "pc_h5" : "h5", h = k.h5Version, i = this._getUuid(), l = b.source ? encodeURIComponent(b.source) : a.video_id, m = "0", n = this.sessionId, o = "0", p = "0", q = "custom", r = "0.0.0.0", s = (new Date).getTime();
                this.opt = {
                    APIVersion: "0.6.0",
                    lv: c,
                    b: d,
                ...
                this.sessionId = h.guid(), this._log("INIT", {}), this.buffer_flag = 0, this.pause_flag = 0
                ...
                this.sessionId = h.guid(), this._log("STOP", {vt: Math.floor(1e3 * this.player.getCurrentTime())})
                ...
                if ((this.buffer_flag || !this.player._options.autoplay) && this.stucking && !this.seeking) {
                    var a = Math.floor(1e3 * this.player.getCurrentTime()), b = this.stuckStartTime || (new Date).getTime(), c = Math.floor((new Date).getTime() - b);
                    c < 0 && (c = 0), this._log("LOADED", {vt: a, cost: c}), this.stucking = !1
                }
            }, _onPlayerHeartBeat: function () {
                if (!this.seeking) {
                    var a = Math.floor(1e3 * this.player.getCurrentTime()), b = this;
                ...
                var a, b = {
                    ...
                    MEDIA_ERR_DECODE: -3
                }, c = this.player.getError(), d = c.code;
                f.each(c.__proto__, function (b, c) {
                    if (c === d)return a = b, !1
                }), b[a] && this._log("ERROR", {
                    vt: Math.floor(1e3 * this.player.getCurrentTime()),
                    error_code: b[a],
                ...
                var c = f.copy(this.opt), d = k.logReportTo;
                c.e = l[a], c.s = this.sessionId, c.ct = (new Date).getTime();
                var e = [];
                f.each(b, function (a, b) {
                    e.push(a + "=" + b)
                }), e = e.join("&"), "" == e && (e = "0"), c.args = encodeURIComponent(e);
                var g = [];
                f.each(c, function (a, b) {
                    g.push(a + "=" + b)
                }), g = g.join("&"), i.jsonp(d + "?" + g, function () {
                }, function () {
                })
            }, _getUuid: function () {
                var a = g.get("p_h5_u");
                return a || (a = h.guid(), g.set("p_h5_u", a, 7)), a
            }
        });
        b.exports = m
    }, {
    ...
    16: [function (a, b, c) {
        var d = a("../ui/component"), e = a("../lib/data"), f = a("../lib/object"), g = a("../config"), h = d.extend({
            init: function (a, b) {
                d.call(this, this, b), this._id = this.id = "prism-player-" + e.guid(), this.tag = a, this._el = this.tag, window[this.id] = this;
                var c = "100%", f = "100%", h = "//" + g.domain + "/de/prismplayer-flash/" + g.flashVersion + "/PrismPlayer.swf", i = this._comboFlashVars(), j = this._options.wmode ? this._options.wmode : "opaque";
                ...
                return navigator.appName.indexOf("Microsoft") != -1 ? document.getElementById(a) : document[a]
                ...
                var a = this._options, b = {
                    ...
                    accessId: a.acId ? a.acId : "",
                    accessKey: a.acKey ? a.acKey : "",
                ...
                var a, b = this._options.skinRes, c = this._options.skinLayout;
                if (c !== !1 && !f.isArray(c))throw new Error("PrismPlayer Error: skinLayout should be false or type of array!");
                ...
                this.trigger("videoRender"), this.trigger("canplay", {loadtime: a})
            }, onVideoError: function (a) {
                this.trigger("error", {errortype: a})
                ...
                // var c = b.indexOf("%");
                // if (c > 0) {
                //     var d = window.screen.height, e = b.replace("%", "");
                //     if (isNaN(e))this._el.style.height = b; else {
        ...
        b.exports = h
    }, {"../config": 1, "../lib/data": 4, "../lib/object": 10, "../ui/component": 18}],
    17: [function (require, module, exports) {
        function sleep(a) {
            for (var b = Date.now(); Date.now() - b <= a;);
        }

        var Component = require("../ui/component"), _ = require("../lib/object"), Dom = require("../lib/dom"), Event = require("../lib/event"), io = require("../lib/io"), UI = require("../ui/exports"), Monitor = require("../monitor/monitor"), UA = require("../lib/ua"), debug_flag = 0, Player = Component.extend({
            init: function (tag, options) {
                if (this.tag = tag, this.loaded = !1, this.played = !1, Component.call(this, this, options), options.plugins && _.each(options.plugins, function (a, b) {
                        this[a](b)
        ...
        Player.prototype.initChildren = function () {
            ...
            Event.on(a, "loadstart", function (a) {
                ...
                b.trigger("canplay", {loadtime: c}), debug_flag && console.log("canplay")
                ...
                b.trigger("waiting"), debug_flag && console.log("waiting")
            }), Event.on(a, "playing", function (a) {
                b.trigger("playing"), debug_flag && console.log("playing")
            }), Event.on(a, "error", function (a) {
                if (console.log("error"), b._options.isLive)b._options.liveRetry ? (sleep(2e3), b.tag.load(b._options.source), b.tag.play()) : b.trigger("error"), b.trigger("liveStreamStop"); else {
                    var c = 0;
                    b._options.source.indexOf("flv") > 0 ? c = 1 : b._options.source.indexOf("m3u8") > 0 && !UA.IS_MOBILE && (c = 1), errmsg = document.querySelector("#" + b.id()), errmsg.style.lineHeight = errmsg.clientHeight + "px", Dom.css(errmsg, "text-align", "center"), Dom.css(errmsg, "color", "#FFFFFF"), c ? errmsg.innerText = "播放失败: h5不支持此格式，请安装flashplayer" : errmsg.innerText = "播放失败: 请确认播放源", b.trigger("error")
                }
            ...
            var a = this._options.vid, b = this;
            ...
            io.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + a + "&playerType=3", function (c) {
                ...
                _.each(c.data.source, function (a, b) {
                    var c = +a.substring(1);
                    c > e && (e = c)
                }), d = c.data.source["v" + e], d = _.unescape(d), b._options.source = d, b._options.trackLog && (b._monitor = new Monitor(b, {
                    video_id: a,
                    album_id: c.data.baseInfo.aid,
                    from: b._options.from
                })), b.trigger("init"), debug_flag && console.log("init"), (b._options.autoplay || b._options.preload) && (b.getMetaData(), b.tag.setAttribute("src", b._options.source), b.readyTime = (new Date).getTime(), b.loaded = !0)
            }, function () {
                throw new Error("PrismPlayer Error: network error!")
            })
        }, Player.prototype.setControls = function () {
            var a = this.options();
            if (a.useNativeControls)this.tag.setAttribute("controls", "controls"); else if ("object" == typeof a.controls) {
            ...
            var a = this;
            return this._options.autoplay || this._options.preload || this.loaded || (this.getMetaData(), this.tag.setAttribute("src", this._options.source), this.readyTime = (new Date).getTime(), this.loaded = !0), a.cover && !a._options.autoplay && (Dom.css(a.cover, "display", "none"), delete a.cover), this.tag.play(), this
            ...
            io.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + a + "&playerType=3", function (c) {
                ...
                _.each(c.data.source, function (a, b) {
                    var c = +a.substring(1);
                    c > e && (e = c)
                }), d = c.data.source["v" + e], d = _.unescape(d), b._options.source = d, b._options.trackLog && (b._monitor ? b._monitor.updateVideoInfo({
                    video_id: a,
                    album_id: c.data.baseInfo.aid,
                    from: b._options.from
                    ...
                    album_id: c.data.baseInfo.aid,
                    from: b._options.from
                })), b._options.autoplay = !0, b.loaded || (b.trigger("init"), debug_flag && console.log("init")), b.getMetaData(), b.tag.setAttribute("src", b._options.source), b.readyTime = (new Date).getTime(), b.loaded = !0, b.cover && b._options.autoplay && (Dom.css(b.cover, "display", "none"), delete b.cover), b.tag.play()
            }, function () {
                throw new Error("PrismPlayer Error: network error!")
            })
        }, Player.prototype.loadByUrl = function (a, b) {
            this._options.vid = 0, this._options.source = a, this._options.autoplay = !0, this._options.trackLog && (this._monitor ? this._monitor.updateVideoInfo({
                video_id: 0,
                album_id: 0,
                from: this._options.from
        ...
        var __supportFullscreen = function () {
            ...
            if (UA.IS_IOS)a.requestFn = "webkitEnterFullscreen", a.cancelFn = "webkitExitFullscreen", a.eventName = "webkitfullscreenchange", a.isFullScreen = "webkitDisplayingFullscreen"; else {
                for (var d = 5, e = 0; e < d; e++)if (c[e][1]in document) {
        ...
        Player.prototype._enterFullWindow = function () {
            ...
            var a = __supportFullscreen, b = this.el(), c = this;
    ...
    18: [function (a, b, c) {
        var d = a("../lib/oo"), e = a("../lib/data"), f = a("../lib/object"), g = a("../lib/dom"), h = a("../lib/event"), i = a("../lib/function"), j = a("../lib/layout"), k = d.extend({
            init: function (a, b) {
                var c = this;
                this._player = a, this._options = f.copy(b), this._el = this.createEl(), this._id = a.id() + "_component_" + e.guid(), this._children = [], this._childIndex = {}, this._player.on("uiH5Ready", function () {
        ...
        k.prototype.renderUI = function () {
            ...
            var a, b, c, d, e;
            if (a = this, b = this.options().children)if (f.isArray(b))for (var g = 0; g < b.length; g++)c = b[g], "string" == typeof c ? (d = c, e = {}) : (d = c.name, e = c), a.addChild(d, e); else f.each(b, function (b, c) {
                c !== !1 && a.addChild(b, c)
            })
            ...
            return b && (this._el.paramData = b), h.trigger(this._el, a), this
    ...
    19: [function (a, b, c) {
        var d = a("../component"), e = a("../../lib/dom"), f = d.extend({
            init: function (a, b) {
        ...
        b.exports = f
    }, {"../../lib/dom": 5, "../component": 18}],
    20: [function (a, b, c) {
        var d = a("../component"), e = d.extend({
            init: function (a, b) {
                ...
                var a = this, b = this.player(), c = b.options(), d = c.showBarTime;
    ...
    24: [function (a, b, c) {
        var d = a("../component"), e = a("../../lib/dom"), f = a("../../lib/event"), g = a("../../lib/ua"), h = a("../../lib/function"), i = d.extend({
            init: function (a, b) {
                ...
                var b = a.touches ? a.touches[0].pageX : a.pageX, c = b - this.el().offsetLeft, d = this.el().offsetWidth, e = this._player.getDuration() ? c / d * this._player.getDuration() : 0;
                e < 0 && (e = 0), e > this._player.getDuration() && (e = this._player.getDuration()), this._player.trigger("seekStart", {fromTime: this._player.getCurrentTime()}), this._player.seek(e), this._player.play(), this._player.trigger("seekEnd", {toTime: this._player.getCurrentTime()})
            }, _onMouseDown: function (a) {
                var b = this;
                a.preventDefault(), this._player.pause(), this._player.trigger("seekStart", {fromTime: this._player.getCurrentTime()}), f.on(this.controlNode, "mousemove", function (a) {
                    b._onMouseMove(a)
                ...
                this._player.seek(b), this._player.play(), this._player.trigger("seekEnd", {toTime: this._player.getCurrentTime()})
                ...
                var b = this.playedNode.offsetWidth / this.el().offsetWidth * this._player.getDuration();
                this._player.getDuration();
                isNaN(b) || (this._player.seek(b), this._player.play()), this._player.trigger("seekEnd", {toTime: this._player.getCurrentTime()})
            }, _onMouseMove: function (a) {
                a.preventDefault();
                var b = a.touches ? a.touches[0].pageX : a.pageX, c = b - this.el().offsetLeft, d = this.el().offsetWidth, e = this._player.getDuration() ? c / d * this._player.getDuration() : 0;
                e < 0 && (e = 0), e > this._player.getDuration() && (e = this._player.getDuration()), this._player.seek(e), this._player.play(), this._updateProgressBar(this.playedNode, e), this._updateCursorPosition(e)
            }, _onTimeupdate: function (a) {
                this._updateProgressBar(this.playedNode, this._player.getCurrentTime()), this._updateCursorPosition(this._player.getCurrentTime()), this._player.trigger("updateProgressBar", {time: this._player.getCurrentTime()})
        ...
        b.exports = i
    }, {"../../lib/dom": 5, "../../lib/event": 6, "../../lib/function": 7, "../../lib/ua": 12, "../component": 18}],
    25: [function (a, b, c) {
        var d = a("../component"), e = a("../../lib/util"), f = d.extend({
            init: function (a, b) {
    ...
    27: [function (a, b, c) {
        ...
        "./component/big-play-button": 19,
        "./component/controlbar": 20,
        "./component/fullscreen-button": 21,
        "./component/live-display": 22,
        "./component/play-button": 23,
        "./component/progress": 24,
        "./component/time-display": 25,
        "./component/volume": 26
    }]
}, {}, [2]);